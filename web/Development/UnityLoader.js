...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3035515;
      var PACKAGE_UUID = 'b6099897-0cc8-4d2d-aec8-af183a5eb8d4';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20296, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20296, 31120, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(31120, 36308, 0, 0).open('GET', '/level0');
    new DataRequest(36308, 36327, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(36327, 36346, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(36346, 64846, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(64846, 1449790, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1449790, 2947162, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(2947162, 3007890, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(3007890, 3035515, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
